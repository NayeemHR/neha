    ...
    <section class="page-title bg-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h1> <?php _e('Top Services', 'neha');?> </h1>
                        <p> <?php _e('We give the best.', 'neha');?> </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page-wrapper">
        <div class="container">
            <div class="row">
                ...
                $neha_top_services = new WP_Query($args);
                while($neha_top_services->have_posts()){
                    $neha_top_services->the_post();
                ?>
                    <div class="col-md-6 ">
                        <div class="post">
