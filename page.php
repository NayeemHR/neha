                ...
                <div class="col-md-12">
                    <div class="post post-single">
                        ...
                        <div class="post-content post-excerpt">
                            <?php the_content(); ?>
        <?php $neha_page_meta = get_post_meta(get_the_ID(), 'page-metabox', true);
                echo esc_html($neha_page_meta['page-heading'])."<br>";
                echo esc_html($neha_page_meta['page-teaser'])."<br>";
//                var_dump($neha_page_meta['is_favorite']);
                if($neha_page_meta['is_favorite']){
                    echo "<h1>Yes</h1>";
                }else{
